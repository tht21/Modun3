        ...
        <div class="left-side border-bottom py-2">
            ...
            <ul>
                @foreach($category as $categories)
                    <li>
                        <a href="{{route('category.product', ['slug' => $categories->slug, 'id' => $categories->id])}}">
                            <input type="checkbox" class="checked">
                            <span class="span">{{$categories->name}}</span>
                        </a>
                    </li>
                    @foreach($categories->sub_categories as $sub_categories)
                        <li>
                            <a href="{{route('category.product', ['slug' => $sub_categories->slug, 'id' => $sub_categories->id])}}">
                                <span class="span">&emsp;&emsp; <input type="checkbox" class="checked">{{$sub_categories->name}}</span>
                            </a>
                        </li>
                    @endforeach
                @endforeach
