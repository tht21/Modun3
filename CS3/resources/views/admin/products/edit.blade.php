...
@endsection
@section('content')
    @include('admin.layouts.includes.contentHeader',['name'=>'Sửa sản phẩm','key'=>'Sửa sản phẩm'])
                            ...
                            <div class="col-lg-6 col-xlg-9 col-md-12">
                                <div class="col-lg-12 col-xlg-9 col-md-12">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-sm-12 border">
                                            <select name="tags[]" class="form-select  tags_select_choose"
                                                    multiple="multiple">
                                                @foreach($products->tags as $tagItem )
                                                    <option value="{{ $tagItem->name }}"
                                                            selected>{{ $tagItem->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
